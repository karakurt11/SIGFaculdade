...
while($dados = mysqli_fetch_array($sql_consulta)){
    ...
    <td> <a href ="eliminarProfessor.php?codigo=<?= $dados[0] ?> "> Eliminar </a> </td>
    <td> <a href ="editarProfessor.php?codigo=<?= $dados[0] ?> "> Editar </a> </td>
    </tr>
   ...
   <?php } ?>
    ...
    <h3><a href="cadastroProfessor.php"> Voltar </a></h3>
